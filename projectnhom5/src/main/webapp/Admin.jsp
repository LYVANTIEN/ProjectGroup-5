    ...
    <body>
           <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
            ...
            <div class=" container-fluid">
                ...
                <!-- Logo brand -->
                <a href="homecontrol" class="navbar-branch">
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="AddProductByAdmin.jsp" class="btn btn-success">Add Product</a>
                    ...
                    <tbody>
                        <c:forEach items="${ListP}" var="o">
                            <tr>
                                ...
                                <td>${o.price} $</td>
                                <td>
                                    <a href="loadadmin?pid=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="deleteall?pid=${o.id}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
