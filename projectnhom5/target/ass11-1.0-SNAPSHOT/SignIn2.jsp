...
<html lang="en" >
            ...
            <div class="form-panel one">
                ...
                <form action="signup" method="post" class="form-signup">
                    ...
                    <div class="form-group">
                        ...
                        <input name="repass" type="password" id="user-repeatpass" required="required"/>
                    </div>
  ...
  <h6 class="text-success" style="padding-top: 24px;text-align: center;">${mess}</h6>
    ...
    <div class="pen-footer"><a href="Login2.jsp"><i class="material-icons">arrow_backward</i>Back Login</a><a href="#" target="_blank">Contact ?<i class="material-icons">arrow_forward</i></a></div>
    <!-- partial -->
