        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-8">						
                        <a href="listproduct" class="btn btn-primary"><i class="material-icons">&#xE863;</i> <span>Home</span></a>
                        ...
                        <c:forEach items="${ListP}" var="o">
                            <tr>
                                ...
                                <td>${o.user}</td>
                                 ...
                                 <td>${o.isAdmin}</td>
                                <td>    
                                    <a href="loadaccount?id=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
